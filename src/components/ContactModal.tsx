      ...
      >
        ...
        <div className="text-center">
          ...
          <div className="mt-5 flex items-center justify-center gap-6">
            <a href="#" aria-label="GitHub" className="text-neutral-700 hover:text-neutral-900"><Github className="w-6 h-6" /></a>
            <a href="#" aria-label="Facebook" className="text-neutral-700 hover:text-neutral-900"><Facebook className="w-6 h-6" /></a>
            <a href="#" aria-label="Instagram" className="text-neutral-700 hover:text-neutral-900"><Instagram className="w-6 h-6" /></a>
            <a href="#" aria-label="LinkedIn" className="text-neutral-700 hover:text-neutral-900"><Linkedin className="w-6 h-6" /></a>
          </div>
        </div>
      </div>
    </div>
